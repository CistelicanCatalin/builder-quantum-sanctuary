...
const schema = z.object({
  ...
  apiKey: z
    .string()
    .min(16, "Cheie invalidă")
    .regex(/^[a-f0-9]{32,128}$/i, "Cheie hex invalidă"),
});
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Introduce link-ul site-ului și cheia API generată de pluginul „WP
            Manager Client”.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
