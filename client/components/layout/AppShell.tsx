  ...
  return (
    <Link to="/" className="flex items-center gap-2 px-2 py-2 rounded-md hover:bg-sidebar-accent">
      <svg width="22" height="22" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12 26l6-12 10 12" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <button className="peer/menu-button flex w-full items-center gap-2 rounded-md p-2 text-left text-sm text-sidebar-foreground/80 cursor-not-allowed" aria-disabled>
      ...
      <SidebarFooter>
        <div className="flex items-center gap-2 rounded-md px-2 py-1.5 bg-sidebar-accent">
          ...
          <div className="min-w-0">
            ...
            <div className="text-[10px] text-sidebar-foreground/70 truncate">Admin</div>
          </div>
        </div>
      </SidebarFooter>
    </>
...
function TopBar() {
  return (
    <div className={cn("sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-background/80 bg-background/70")}> 
